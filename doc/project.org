...
**** TODO Convert KeyType to new enum style
**** TODO Convert LevelType to new enum style
*** TODO Player and Enemy should have superclass Creature
*** TODO Player should keep track of that action is performed
** Input
*** TODO Interface for reading keys
*** TODO Flixel implementation of reading keys
** Level
