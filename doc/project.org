...
** Point
*** TODO Add getPointsAround method
...
**** TODO Weak to fire
***** TODO Add attackedWithFire to Enemy
***** TODO Call enemy.attackedWithFire when swinging torch
**** TODO Undead enemy
***** DONE Class
***** DONE Override getter for causesFear
***** DONE Override getter for fearType
***** TODO Inflicts poison
***** TODO Override attackedWithFire
*** TODO Mimic
*** TODO Watershade
*** TODO Slime
*** TODO Stoneworm
